...
public class DestinyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_destiny, container, false);

        button = root.findViewById(R.id.destinyButtonClear);
        textArea = root.findViewById(R.id.destinyTextArea);
